...
<html>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            &emsp14;
            <a class="navbar-brand" href="sell.htm">Sell product on our Platform.</a>
    ...
    <center>
        ...
        <form action="list.htm" method="POST">
            <table>
                <tr>
                    <td>name</td>
                    <td><input type="text" name="name" placeholder="Name of commodity"></td>
                </tr>
                <tr>
                    <td>quantity</td>
                    <td><input type="number" id="qty" name="quantity" min="1" onkeyup="check_null()" onclick="check_null()" onkeydown="check_null()"></td>
                </tr>
                <tr>
                     <td>price</td>
                ...
                <tr>
                     ...
                     <td>
                         <select name="type">
                             ...
                             <option>Fashion Ware</option>                             
                         </select>
                     </td>
                </tr>
            </table>
            <br>
            <input type="submit" class="btn btn-primary" value="Sell commodity">
        </form>
        </div>
        <br>
        <br>
